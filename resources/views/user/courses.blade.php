        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="rating">
                        <div class="boxing">
                            <img src="{!!asset('public/imagesh/program4.png')!!}" alt="Avatar" class="image" style="width:100%">
                            <div class="middle">
                                <div class="text" >
                ...
                <div class="col-sm-3">
                    <div class="rating">
                        <div class="boxing">
                            <img src="{!!asset('public/imagesh/program1.png')!!}" alt="Avatar" class="image" style="width:100%">
                            <div class="middle">
                ...
                <div class="col-sm-3">
                    <div class="boxing">
                        <img src="{!!asset('public/imagesh/program2.png')!!}" alt="Avatar" class="image" style="width:100%">
                        <div class="middle">
                            <div class="text">View</div>
                ...
                <div class="col-sm-3">
                    <div class="boxing">
                        <img src="{!!asset('public/imagesh/program3.png')!!}" alt="Avatar" class="image" style="width:100%">
                        <div class="middle">
                            <div class="text">View</div>
                        </div>
                    </div>
                        ...
                        <div class="second-line">
                            ...
                            <div class="second-line">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="boxing">
                                            <img src="{!!asset('public/imageshs/program3.png')!!}" alt="Avatar" class="image" style="width:100%">
                                            <div class="middle">
                                                <div class="text">View</div>
                                            </div>
                                        </div>
