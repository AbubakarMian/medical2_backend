                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="form-group lube"> <label> User Name:</label>
                            <div class="input-group">
                                ...
                                <input type="text" name="user" class="lubin lbtext" disabled value="{{$c_r->user->name}}" class="form-control" placeholder="Enter User" />
                                <span class="input-group-addon"></span>
                    ...
                    <div class="row my_amount_date_{{$c_r->user_id}}_{{$c_r->id}}">
                        <div class="col-xs-6">
                            <div class="form-group lube"> <label> Amount:</label>
                                <div class="input-group">
                                    <input type="text" name="amount" class="lubin lbtext" disabled value="{{$c_r->amount}}" class="form-control" placeholder="Enter Amount" />
                                    <span class="input-group-addon"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group lube"> <label> Due Date:</label>
                                <div class="input-group">
                                    <input type="text" name="amount" class="lubin lbtext" disabled value="{{date('d-m-Y', $c_r->due_date) }}" class="form-control" placeholder="Enter Amount" />
                                    <span class="input-group-addon"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <label class="switch grouswitch">
                            <input type="checkbox" class="highlight_class_{{$c_r->user_id}}_{{$c_r->id}} {!!$uniq_user_fees_class!!}" 
                                onchange="highlight_div('{{$fees_key}}','{{$c_r->id}}','{{$c_r->user_id}}','{{$c_r->amount}}')" name="student_id[]" value="{{$c_r->id}}">
        ...
        function highlight_div(fees_key, group_fess_id, user, group_fees_amount) {
            ...
            if (valid_fees_selection) {
                ...
                if ($(highlight_class).is(':checked')) {
                    ...
                    var my_amount_date = $('.my_amount_date_' + user + '_' + group_fess_id).css("background-color", "#efefef", "padding", "6px", "margin-bottom" ,"10px");
                    ...
                    var my_amount_date = $('.my_amount_date_' + user + '_' + group_fess_id).css("background-color", "");
                    all_amount = parseFloat(all_amount) - parseFloat(group_fees_amount);
                }
