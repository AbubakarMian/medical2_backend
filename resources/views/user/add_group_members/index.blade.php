...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-sm-12">
                <form role="form" method="post" action="{{ action('User\CoursesController@group_registration_save') }}">
                    ...
                    <button type="submit" class="btn btn-primary regi show_register"
                        style="margin-top:20px; display:none">Register</button>
    ...
    <script>
        function add_members() {
            ...
            $add_members_register_form = $('.add_members_register_form').append(add_members_register_form_area(
                div_add_members_register_form_area));
        ...
        function add_members_register_form_area(v) {
            return (
                `
                <div class="div_add_members_register_form_area mainhed">
    <h3>
        Registration Form
    </h3>
    <button type="button" class="btn btn-danger rgm" onclick="remove_form_area(this)" style="">Remove Group
        Members</button>
