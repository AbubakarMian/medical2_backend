                        ...
                        <div class="regeformdata">
                            ...
                            <form>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <select class="form-control" id="one">
                                    ...
                                    <option>Pharmacy Technician</option></select>                        
                                  </select>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" placeholder="Medical certification or license">
                                </div>
                              </div>

                              <div class="row">
                                <div class="col-sm-12">
                                  <textarea class="form-control" id="eight" placeholder="Work experience" rows="4"></textarea>
                                </div>                               
                              </div>  

                              <div class="row">
                                <div class="col-sm-12">
                                  <textarea class="form-control" id="seven" placeholder="Why do you want to take this program?" rows="4"></textarea>
                                </div>                               
                              </div>                                                            
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  ...
                                  <button type="button" class="btn btn-primary resub">Submit</button>
                                </div>                               
                              </div>
