                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" name="date" id="reservationtime" class="form-control active" value="{!!$date!!}">
                        </div>
                    </div>
                </div>
            </fieldset>
...
<div class="col-xs-3 pull-left" style="padding-top: 16px;">
    ...
    {!!Form::text('payment_id',$search_payment,
                    ['class'=>'form-control' , 'id'=>'user','placeholder'=>'Name'])!!}
</div>
    ...
    <div class="col-md-2 pull-left" style="margin-top: 16px;">
