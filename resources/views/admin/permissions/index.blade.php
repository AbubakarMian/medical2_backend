        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="chechkareadata">
                    <label for="exampleInputtext1" class="rolabel">Select Template :</label>
                    {!!Form::select('role_id',$role_template,$user->role_id,
                    ['class'=>'permission_template','id'=>'permission_template',
                                        ...
                                        <tr id="panel_{!!$p->id!!}">
                                            @foreach ( $details as $key=> $d)
                                                ...
                                                <th >{!!ucwords($d->heading) !!}
                                                    <input type="checkbox" {!!$is_checked!!} id="permission_{!!$p->id!!}" name="permissions[{!!$p->id!!}][]" value="{!!$d->id!!}"></th>
                                            @endforeach
                                        </tr>
                                    </thead>
                                    <tbody>
