...
@section('add_btn')
{!! Form::open(['method' => 'get', 'url' => ['admin/teacher/create'], 'files' => true]) !!}
<span>{!! Form::submit('Add Teacher', ['class' => 'btn btn-success pull-right']) !!}</span>
{!! Form::close() !!}
@stop
         ...
         success: function(response){
           ...
           console.log(response);
              ...
              for(var i=0; i<len; i++){
				  ...
				  var edit = `<a class="btn btn-info" href="{!!asset('admin/teacher/edit/` + id + `')!!}">Edit</a>`;
                       createModal({
                            id: 'teacher_' + response['data'][i].id,
                            header: '<h4>Delete</h4>',
