...
@section('add_btn')
    {!! Form::open(['method' => 'get', 'url' => ['admin/books/create'], 'files' => true]) !!}
    <span>{!! Form::submit('Add Books', ['class' => 'btn btn-success pull-right']) !!}</span>
    {!! Form::close() !!}
@stop
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchRecords() {
                ...
                $.ajax({
                    url: '{!! asset('admin/books/get_books') !!}',
                    type: 'get',
                    dataType: 'json',
                    success: function(response) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            var edit =
                            `<a class="btn btn-info" href="{!! asset('admin/books/edit/` + id + `') !!}">Edit</a>`;
                            createModal({
                            ...
                            var delete_btn =
                                ...
                                'books_' + response['data'][i].id + `">Delete</a>`;
        ...
        function delete_request(id) {
            $.ajax({
                ...
                url: "{!! asset('admin/books/delete') !!}/" + id,
                type: 'POST',
                dataType: 'json',
                data: {
                    _token: '{!! @csrf_token() !!}'
